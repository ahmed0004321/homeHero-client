                ...
                {booking.map((book) => (
                  ...
                  >
                    <td className="px-6 py-4 flex items-center gap-3">
                        <img className="w-10 h-10 rounded-lg" src={book.serviceDetails.imageUrl} alt="" />
                      <p className="font-semibold">{book.serviceDetails.serviceName}</p>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center">
                        <button className="p-2 bg-red-500/20 hover:bg-red-500/40 rounded-lg transition-all group">
